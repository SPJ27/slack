...
const ChannelHeader = ({ data, members, id }: ChannelHeaderProps) => {
  ...
  const inviteCache = useRef(new Map<string, InviteUser[]>());
  ...
  useEffect(() => {
    ...
    const timeout = setTimeout(async () => {
      ...
      try {
        ...
        const data: InviteUser[] = await res.json();
      ...
      channel = supabase
        ...
        .on(
          ...
          (payload: RealtimePostgresInsertPayload<Message>) => {
            ...
            if (newMessage.type !== "CHANNEL") return;
